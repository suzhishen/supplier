...
export class fastOrderCenterFollowTreeBlankIn extends Component {
    setup() {
...
fastOrderCenterFollowTreeBlankIn.template = "fastOrderCenter.followTreeBlankIn";


registry.category("actions").add("fast_order_center_follow_tree_blank_in", fastOrderCenterFollowTreeBlankIn);